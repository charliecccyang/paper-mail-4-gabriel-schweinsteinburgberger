...
public class CollectCommand extends UserProfileCommand {
    private final Map<UserProfilePropertyName, UserProfilePropertyValue> properties;

    @JsonCreator
    public CollectCommand(@JsonProperty("userId") UserId userId,
    ...
    public void apply(UserProfile userProfile) {
        properties.forEach(userProfile::collectProperty);
    }
