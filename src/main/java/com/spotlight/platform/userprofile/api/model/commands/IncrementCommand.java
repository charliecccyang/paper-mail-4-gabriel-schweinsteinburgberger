...
public class IncrementCommand extends UserProfileCommand {
    private final Map<UserProfilePropertyName, UserProfilePropertyValue> properties;

    @JsonCreator
    public IncrementCommand(@JsonProperty("userId") UserId userId,
    ...
    public void apply(UserProfile userProfile) {
        properties.forEach(userProfile::incrementProperty);
    }
}
